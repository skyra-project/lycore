...
namespace LyCore.Controllers
{
	...
	public class ImageController : Controller
	{
		...
		/// </example>
		[HttpGet("profile")]
		public async Task<ActionResult<byte[]>> BasicProfileController([FromQuery] string avatarUrl,
		...
		{
			return new FileContentResult(await BasicProfile.GenerateAsync(avatarUrl, username,
		...
		/// <returns>The action result from this profile.</returns>
		/// <example>
		///     curl 'http://localhost:8990/image/premium-profile'                                                                \
		///     -d avatarUrl=https://cdn.discordapp.com/avatars/242043489611808769/a_adcd82c10a4d7241ca876b7920e4d357.png \
		///     -d username=kyra                                                                                          \
		///     -d discriminator=0001                                                                                     \
		///     -d level=188                                                                                              \
